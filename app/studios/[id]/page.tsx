...
const studiosData = [
  {
    ...
    photos: Array.from({length: 28}, (_, i) => `/studios/studio1/__1_${String(i+1).padStart(2,"0")}.jpg`),
  },
  {
    id: 2,
    ...
    photos: Array.from({length: 28}, (_, i) => `/studios/studio2/__1_${String(i+1).padStart(2,"0")}.jpg`),
  },
  {
    id: 3,
    ...
    photos: Array.from({length: 29}, (_, i) => `/studios/studio3/__3_${String(i+1).padStart(2,"0")}.jpg`),
  },
]
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-4xl mx-auto py-10 px-6">
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          ...
          <div className="bg-blue-50 rounded-xl px-4 py-3 text-blue-800 text-sm mb-4">{studio.extra}</div>
          <div>
