...
export default function SettingsPage() {
  ...
  const requestNotifPermission = async () => {
    ...
    if (result === "granted") {
      new Notification("�������������", {
        body: lang === "ru" ? "����������� ��������!" : "Notifications enabled!",
        icon: "/favicon.ico",
      })
    }
  }
  ...
  const notifItems = lang === "ru" ? [
    { key: "booking_created", label: "�������� ������������", desc: "��� �������� ������������" },
    { key: "booking_cancelled", label: "������ ������������", desc: "��� ������ �����" },
    { key: "checkin_reminder", label: "����������� � ���������", desc: "�� ���� �� ������" },
    { key: "checkout_reminder", label: "����������� � ���������", desc: "�� ���� �� ������" },
  ] : [
  ...
  const themeItems = [
    { value: "light", label: "??", name: t("settings.light"), desc: lang === "ru" ? "������ �������" : "Always light" },
    { value: "dark", label: "??", name: t("settings.dark"), desc: lang === "ru" ? "������ �����" : "Always dark" },
    { value: "system", label: "??", name: t("settings.system"), desc: lang === "ru" ? "��� �� ����������" : "Match device" },
  ]
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <header className="bg-white dark:bg-gray-900 shadow-sm px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <SideMenu />
          <a href="/" className="text-xl font-bold text-blue-600">�������������</a>
        </div>
      ...
      <div className="max-w-2xl mx-auto py-10 px-6 flex flex-col gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm p-6">
          ...
          {notifPermission === "granted" && <div className="bg-green-50 text-green-700 px-3 py-2 rounded-lg text-sm mb-4">? {lang === "ru" ? "����������� ���������" : "Notifications enabled"}</div>}
          {notifPermission === "denied" && <div className="bg-red-50 text-red-600 px-3 py-2 rounded-lg text-sm mb-4">? {lang === "ru" ? "����������� �������������" : "Notifications blocked"}</div>}
