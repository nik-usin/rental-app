    ...
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <section className="max-w-3xl mx-auto py-16 px-6 w-full">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://t.me/ваш_ник" className="bg-blue-500 text-white px-6 py-4 rounded-xl font-semibold hover:bg-blue-600 inline-flex items-center justify-center gap-3 flex-1">
